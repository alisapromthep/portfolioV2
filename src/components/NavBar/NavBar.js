        ...
        <div className='nav'>
            ...
            <div>
                <ul className='nav__list'>
                    ...
                    <li className='nav__link nav__icon'><a href="https://www.linkedin.com/in/alisa-promthep/"
                    target="_blank"
                    rel="noopener"><FaLinkedin color="#F5EAE5" size={20}/></a></li>
                    <li className='nav__link nav__icon'><a 
